INSERT INTO cars (lister_id, year, make, model, color, description, price, photo, timestamp, body_type, kms)
 VALUES (1, 2010, 'Ferrari', 'F8 Spider', 'yellow', 'Its fast', 150000, 'https://car-images.bauersecure.com/wp-images/3639/ferrari_f8_spider_66.jpg', '2022-10-30T17:46:30.297Z', 'convertible', 55000),
        ...
        (3, 2021, 'Aston Martin', 'Vantage', 'grey', 'Vroom vroom', 125000, 'https://amsc-prod-cd.azureedge.net/-/media/aston-martin/images/default-source/models/new-vantage/new/amf1-performance2.jpg', '2020-07-01T12:01:55.000Z', 'coupe', 6000),
        (3, 2017, 'Bugatti', 'Chiron', 'blue', 'Fancy!', 125000, 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/Bugatti_Chiron_%2836559710091%29.jpg/1200px-Bugatti_Chiron_%2836559710091%29.jpg', '2020-06-09T15:56:55.000Z', 'coupe', 40000),
